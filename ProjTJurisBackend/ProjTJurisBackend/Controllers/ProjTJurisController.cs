...
using ProjTJurisBackend.Models;

namespace ProjTJurisBackend.Controllers
{
    
        [ApiController]
        [Route("api/[controller]")]
        public class ProjTJurisController : ControllerBase
        {

            private static readonly List<Processo> processos = new List<Processo>();

            [HttpPost("abrir")]
            public IActionResult AbrirProcesso([FromBody] Processo processo)
            {
